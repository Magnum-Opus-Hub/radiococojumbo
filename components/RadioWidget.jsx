...
export default function RadioWidget() {
  ...
  async function playSound() {
    ...
    const { sound } = await Audio.Sound.createAsync( {uri:'http://streaming.radio.co/sced7c0e79/listen'})
    setSound(sound);
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-10 h-10 fill-red-500" fill="currentColor" id="pause"><path fillRule="evenodd" clipRule="evenodd" d="M8 5a2 2 0 0 0-2 2v10a2 2 0 1 0 4 0V7a2 2 0 0 0-2-2zm8 0a2 2 0 0 0-2 2v10a2 2 0 1 0 4 0V7a2 2 0 0 0-2-2z"></path></svg>
</Button>
